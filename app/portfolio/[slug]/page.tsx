...
export default function CaseStudyDetail({
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await fetch(`${API}/portfolio?slug=${slug}&_embed`);
        ...
        // 🔥 fetch related
        const res2 = await fetch(`${API}/portfolio?_embed`);
    ...
    <main className="min-h-screen bg-white">
                ...
                <div className="border-t border-gray-100 pt-10">
                  <div className="space-y-6">
                    ...
                    <div className="flex justify-between">
                      <span>Language</span>
                      <span className="font-bold">{acf.language}</span>
                    </div>

                    <div className="flex justify-between">
                      <span>Timescale</span>
                      <span className="font-bold">{acf.duration}</span>
                    </div>

                    <div className="flex justify-between">
                      <span>System</span>
                      <span className="font-bold">{acf.system}</span>
                    </div>
            ...
            <article className="lg:col-span-8 order-1 lg:order-2 space-y-20">
              ...
              <div className="bg-gray-50 rounded-[3rem] p-8 md:p-16">
                ...
                <div className="grid sm:grid-cols-2 gap-8">
                  {[acf.result_1, acf.result_2, acf.result_3, acf.result_4]
                    .filter(Boolean)
                    .map((r, i) => (
                      <div
                        key={i}
      ...
      <section className="section-padding bg-gray-50">
        <div className="container-custom">
          ...
          <h2 className="text-4xl font-bold mb-4">Related Works</h2>
              ...
              .map((item) => {
                ...
                return (
                  <Link key={item.id} href={`/portfolio/${item.slug}`}>
                    <div className="group">
                      <img src={img} className="rounded-3xl mb-6" />
